...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'core_photo', 'title')

        # Deleting field 'Photo.note'
        db.delete_column(u'core_photo', 'note')


    def backwards(self, orm):
        # Adding field 'Photo.title'
        db.add_column(u'core_photo', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)

        # Adding field 'Photo.note'
        db.add_column(u'core_photo', 'note',
    ...
    models = {
        ...
        u'core.species': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'occurrenceCount': ('django.db.models.fields.PositiveIntegerField', [], {})
        }
    }
