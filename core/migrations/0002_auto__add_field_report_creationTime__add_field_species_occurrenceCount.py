...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.creationTime'
        db.add_column(u'core_report', 'creationTime',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 7, 12, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Species.occurrenceCount'
        db.add_column(u'core_species', 'occurrenceCount',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.creationTime'
        db.delete_column(u'core_report', 'creationTime')

        # Deleting field 'Species.occurrenceCount'
        db.delete_column(u'core_species', 'occurrenceCount')
